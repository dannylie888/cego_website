...
export default function Navbar() {
  ...
  return (
    ...
    >
      <div className="max-w-screen-2xl mx-auto px-6 sm:px-8 flex items-center justify-between">
        {/* Logo */}
      ...
      <div ref={menuRef} className="md:hidden overflow-hidden h-0 opacity-0 bg-[#1A1512]/98">
        <div className="max-w-screen-2xl mx-auto px-6 sm:px-8 py-8 flex flex-col gap-6">
          {navLinks.map((key) => (
            <button
              key={key}
              onClick={() => handleNav(key)}
